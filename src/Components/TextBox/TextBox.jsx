    ...
    <div id="parent">
      <div id="txt-box">
        <form id="inp-box" onSubmit={handleSubmit}>
          ...
          <div id="btn">
            <button style={{  marginTop: '10px'}} type="submit">Summarise</button>
      ...
      <button onClick={downloadTextSummary} style={{ marginRight: '10px', backgroundColor: 'lightblue', color: 'black' }}>
        Download Text
      </button>
      <button onClick={downloadPDFSummary} style={{ backgroundColor: 'lightgreen', color: 'black' }}>
        Download PDF
      </button>
    </div>
          </div>
