        ...
        <>
          <TextSummarizer /> 
            <form onSubmit={handleSubmit} id='registeration-form'>
                ...
                <input style={{marginBottom:"20px"}} type="text" placeholder='Name' onChange={(e) => { setName(e.target.value) }} /><br />
                <input style={{marginBottom:"20px"}}  type="text" placeholder='Address' onChange={(e) => { setAddress(e.target.value) }} /><br />
                <input style={{marginBottom:"20px"}} type="email" placeholder='Email' onChange={(e) => { setEmail(e.target.value) }} /><br />
